...
// Interface to handle userId without TypeScript errors
...
export const makeRevision = async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        // 3. Enhance user prompt
        const promptEnhanceResponse = await openai.chat.completions.create({
            model: 'kwaipilot/kat-coder-pro:free', // Make sure this model is correct for your API
            messages: [{
                role: 'system',
    ...
    try {
        ...
        await prisma.websiteProject.update({
            ...
            data: {
                ...
                current_version_index: targetVersion.id
            }
        });
