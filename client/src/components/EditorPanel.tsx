...
const EditorPanel = ({selectedElement, onUpdate, onClose}: EditorPanelProps) => {
  ...
  return (
    <div className='absolute top-4 right-4 w-80 bg-white rounded-Ig shadow-x1 border border-gray-200 p-4 z-50 animate-in fade-in slide-in-from-right-5'>
    ...
    <div className='space-y-4 text-black'>
        <div>
            <label htmlFor="block text-xs font-medium text-gray-500 mb-1">Text Content</label>
        ...
        <div>
             <label htmlFor="block text-xs font-medium text-gray-500 mb-1">Class Name</label>
        ...
        <div>
                ...
                <div className='flex items-center gap-2 border border-gray-400 rounded-md p-1'>
                    <input type='color'
                value={values.styles.color} onChange={(e)=>handleStyleChange('color', e.target.value)} className='w-6 h-6 cursor-pointer'/>
