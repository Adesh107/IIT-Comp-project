        ...
        <div className="py-10 min-h-[80vh]">
          <div className="flex items-center justify-between mb-12">
            ...
            <button
              ...
              rounded bg-gradient-to-br from-indigo-500 to-indigo-600
          ...
          <div className="flex flex-wrap gap-3.5">
            {projects.map((project) => (
              <div onClick={()=> navigate(`/projects/${project.id}`)} key={project.id}className="relative w-72
              ...
              transition-all duration-300">
                ...
                <div className="relative w-full h-40 overflow-hidden border-b border-gray-800 bg-gray-900">
                  {project.current_code ? (
                    <div className="origin-top-left scale-[0.25] w-[1200px] h-[800px]">
                      <iframe
                 ...
                 to-transparent transition-colors'>
                  <div className='flex items-start justify-between'>
                      <h2>{project.name}</h2>
                      <button className='px-2.5 py-0.5 mt-1 m1-2
                 ...
                 <div onClick={e => e.stopPropagation()}>
                   ...
                   rounded text-red-500 text-x1 cursor-pointer
                   transition-all' onClick={()=>deletedProject(project.
                    id)}/>
                 </div>
              </div>
            ))}
